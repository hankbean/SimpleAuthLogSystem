            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    try
                    {
                        ...
                        if (user != null)
                        {
                            _auditService.LogAction(user.Id, $"使用者 '{user.UserName}' (ID: {user.Id}) 已登入系統");
                    ...
                    {
                        _logger.LogError(ex, "寫入登入日誌時發生錯誤");
                    }
                ...
                {
                    ModelState.AddModelError(string.Empty, "登入失敗，請檢查您的帳號或密碼。");
                    return Page();
                }
            }
